...
public class PageFormulario extends ConfigBase {
	...
	public void registrarFormulario(ITestResult testResult,BeanFormulario beanFormulario) throws InterruptedException,IOException, Exception{
		...
		UtilitariosButton.btn_clic(buttonSiguiente, driver, testResult);
		UtilitariosButton.btn_clic(buttonEnviar, driver, testResult);
